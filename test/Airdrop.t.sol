...
function testReplayAttackBySameAccount() public {
    ...
    bool success = callAirdropClaim(owner, amount, sig);
...
function callAirdropClaim(address claimant, uint256 amount, Airdrop.Signature memory sig) internal returns (bool) {
    ...
    function _signMessage(address claimant, uint256 amount) internal returns (uint8, bytes32, bytes32) {
